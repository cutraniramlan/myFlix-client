...
//     const getUserData = () => {
//       const url = `https://movie-api-rani-1.herokuapp.com/users/${storedUser.Username}`;
...
//       fetch(`https://movie-api-rani-1.herokuapp.com/users/${storedUser.Username}`, {
//         method: "PUT",
...
//       const url = `https://movie-api-rani-1.herokuapp.com/users/${userData.Username}`;
...
export class ProfileView extends React.Component {
  ...
  getUser = (token) => {
    ...
    axios
      .get(`https://movie-api-rani-1.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        this.setState({
  ...
  editUser = (e) => {
    ...
    axios
      .put(
        `https://movie-api-rani-1.herokuapp.com/users/${Username}`,
        {
  ...
  onRemoveFavorite = (movie) => {
    ...
    axios
      .delete(
        `https://movie-api-rani-1.herokuapp.com/users/${Username}/movies/${movie._id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://movie-api-rani-1.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
